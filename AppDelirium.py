...
filters_container.write("Please complete all the information requested below to make a prediction of delirium. If you do not modify the content of a field, the default value will be applied")
